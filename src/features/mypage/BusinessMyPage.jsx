...
const UserProfileTab = () => {
  ...
  return (
    _jsxDEV("div", { className: "bg-white border border-emerald-100 rounded-lg p-8 shadow-sm", children: [
      _jsxDEV("h2", { className: "text-xl font-bold mb-2", children: "개인정보 확인" }, void 0, false),
      _jsxDEV("p", { className: "text-sm text-gray-500 mb-8 border-b border-gray-100 pb-4", children: "가입 시 등록한 정보를 확인합니다." }, void 0, false),
      ...
      _jsxDEV("div", { children: [
        ...
        _jsxDEV("div", { className: "grid grid-cols-2 gap-6", children: [
          _jsxDEV("div", { children: [
            ...
            _jsxDEV("div", { className: "w-full aspect-video rounded-xl overflow-hidden border border-gray-100 bg-gray-50", children:
              _jsxDEV("img", { src: storeImg1, alt: "가게 외관", className: "w-full h-full object-cover" }, void 0, false) }, void 0, false
            )] }, void 0, true
          ),
          _jsxDEV("div", { children: [
            _jsxDEV("label", { className: "block text-xs font-semibold text-gray-500 mb-2", children: "가게 내관" }, void 0, false),
            _jsxDEV("div", { className: "w-full aspect-video rounded-xl overflow-hidden border border-gray-100 bg-gray-50", children:
              _jsxDEV("img", { src: storeImg2, alt: "가게 내관", className: "w-full h-full object-cover" }, void 0, false) }, void 0, false
            )] }, void 0, true
          )] }, void 0, true
        )] }, void 0, true
      )] }, void 0, true
    ...
    _jsxDEV("div", { className: "min-h-screen bg-[#FAFAFA] flex flex-col font-sans", children:
      _jsxDEV("main", { className: "flex-grow w-full max-w-6xl mx-auto px-4 py-10 flex gap-8", children: [
        ...
        _jsxDEV("section", { className: "flex-grow", children:
          activeTab === '개인정보 확인' ?
          _jsxDEV(UserProfileTab, {}, void 0, false) :
